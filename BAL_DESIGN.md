...
## Mission
Create implementation-ready, token-driven UI guidance for BALMUDA（バルミューダ）公式サイト that is optimized for consistency, accessibility, and fast delivery across e-commerce storefront.
...
- Include known page component density: links (81), buttons (14), lists (9).
